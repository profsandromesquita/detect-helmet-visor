'''
Code adjusted for use on the Linux operating system
'''

import cv2
import numpy as np
import pygame # Importa a biblioteca para tocar o som
...
class Alarme(threading.Thread):
    def __init__(self):
        ...
        pygame.init()
        self.sound = pygame.mixer.Sound('sounds/error.mp3')  # Especifique um arquivo de som
